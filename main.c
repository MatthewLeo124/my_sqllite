...
//Type: Integer(4 bytes), varchar(32), varchar(255)
...
//Each row is 291 bytes
//id is 4 bytes as its an int
//username is 32 bytes and thus has a 4 byte offset
//email is 255 bytes and thus has a 36 byte offset
...
//Database 'front-end' that is the SQL compiler
...
int main(int argc, char* argv[]) {
    ...
    while (true) {
        ...
        //Recognise meta commands or non-sql commands
        ...
        //Recognise SQL commands if not meta
        Statement statement;
